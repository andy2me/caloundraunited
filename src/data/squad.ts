...
export const squad: Player[] = [
  ...
  { group: 'def', num: 17, name: 'Keith Gargan',    nick: '"The Gargoyle"',   position: 'LB',
  ...
  { group: 'def', num: 16, name: 'Luke Heazlwood',  nick: '"Heazlblock"',     position: 'RB',
  ...
  { group: 'mid', num: 5,  name: 'Nigel Robertson',    nick: '"Robbo"',              position: 'CDM',
  ...
  { group: 'staff', name: 'Dan Hope', nick: '"Coach"',
    position: 'Coach',
    image: 'player-hope.webp',
    stat: 'Loves <strong>delegating</strong> and a good pep talk. Edits the match replay between mouthfuls of dinner. Would <strong>die for Caloundra United</strong>. Lynne — Club Secretary — is his most-dialled number.' },
  { group: 'staff', name: 'Andy Twomey', nick: '"Admin Mule"',
    position: 'Manager',
    image: 'player-twomey.webp',
    stat: 'Files the incident reports, drags the kit bag, books the pitches, chases the subs, ferries the cones. Title says Manager; the job is <strong>everything nobody else wants to do</strong>.' },
