...
export const squad: Player[] = [
  ...
  { group: 'mid', num: 8,  name: 'Andy Twomey',        nick: '"Tomo"',               position: 'CM · CAPT', isCaptain: true,
    image: 'player-twomey.webp',
    stat: 'Captain. Manager. Spends <strong>both halves</strong> shouting at himself in the third person.' },
